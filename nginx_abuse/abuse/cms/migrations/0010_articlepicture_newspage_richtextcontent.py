...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('cms', '0009_delete_paretnforsidebar'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='cms.NewsPage', verbose_name='Parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='richtextcontent_set', to='cms.NewsPage')),
            ],
            options={
                'verbose_name': 'rich text',
                'verbose_name_plural': 'rich texts',
                'db_table': 'cms_newspage_richtextcontent',
                'ordering': ['ordering'],
                'permissions': [],
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(max_length=255)),
                ('ordering', models.IntegerField(default=0, verbose_name='ordering')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articlepicture_set', to='cms.NewsPage')),
            ...
            options={
                ...
                'db_table': 'cms_newspage_articlepicture',
                'ordering': ['ordering'],
                'permissions': [],
                'abstract': False,
            },
